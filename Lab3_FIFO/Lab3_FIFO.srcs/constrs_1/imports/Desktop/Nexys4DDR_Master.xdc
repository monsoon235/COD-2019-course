...
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { en_out }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { en_in }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
