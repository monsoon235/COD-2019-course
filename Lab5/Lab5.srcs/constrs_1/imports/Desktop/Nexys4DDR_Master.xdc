...
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { inc_or_dec }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { mem_or_reg }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { cont }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { delta }]; #IO_L4N_T0_D05_14 Sch=btnu
